...
/* Fix: Removed duplicate GlobeIcon declaration */
...
// Added title prop to support accessibility tooltips and fix TS errors in usage
export const FireIcon = ({ className, title }: { className?: string, title?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" stroke="none" className={className} aria-hidden="true">
